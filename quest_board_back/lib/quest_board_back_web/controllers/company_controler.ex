defmodule QuestBoardBackWeb.CompanyControler do
  use QuestBoardBackWeb, :controller

  alias QuestBoardBack.Service.Company.Create
  alias QuestBoardBack.Service.Company.Read
  alias QuestBoardBack.Service.Company.Delete
  alias QuestBoardBack.Service.Company.Update
